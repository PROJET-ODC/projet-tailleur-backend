...
router
  ...
  .delete(tailleurController.deleteStatus);
...
router
  .route("/posts/:postId")
  .put(tailleurController.updatePost)
  .delete(tailleurController.deletePost);
router.get("/user/posts/:id", tailleurController.getPostsByCompteId);

router.route("/achetercredit").post(tailleurController.acheterCredit);
router
  .route("/articles/categories")
  .get(tailleurController.getArticleCategories);
...
router
  .route("/approvisions/payereste")
  .post(tailleurController.payerResteCommande);

router
  .route("/approvisions/details")
  .get(tailleurController.detailsApprovisions);
